/**
 * SQLite database access layer for the Finantsinspektsioon MCP server.
 *
 * Schema mirrors the EFSA regulatory document structure:
 *   - sourcebooks        — top-level document categories (FI_Juhendid, FI_Soovituslikud_Juhendid, FI_Ringkirjad)
 *   - provisions         — individual guidelines, recommendations, and circular provisions
 *   - enforcement_actions — EFSA supervisory decisions and enforcement measures
 *
